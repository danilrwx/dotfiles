...
local theme = lush(function()
  return {
    ...
    DiffAdd      { fg = "#94b979" }, -- diff mode: Added line |diff.txt|
    DiffChange   { fg = "#97bedc" }, -- diff mode: Changed line |diff.txt|
    DiffDelete   { fg = "#e27373" }, -- diff mode: Deleted line |diff.txt|
    DiffText     { fg = total_black }, -- diff mode: Changed text within a changed line |diff.txt|
